...
studyArea <- usefulFuns::provinceBCRStudyArea(province = c("British Columbia", 
                                                           "Alberta", 
                                                           "Northwest Territories"), 
                                              country = "Canada")

boreal <- defineStudyArea(testArea = TRUE, specificTestArea = "boreal", 
                          destinationFolder = Paths$inputPath)
boreal <- boreal[boreal@data$TYPE == "BOREAL",]

studyArea <- projectInputs(studyArea, targetCRS = raster::crs(templateRaster))
