...
This module creates a model using total biomass of soft and hardwood for Red-breasted Nuthatch. The covariates can be used in an anticipation function for harvesting.

# Usage

```{r module_usage}

# Make sure you have the most updated raster and sp versions
install.packages("raster")
install.packages("sp")

require("Require")
Require("SpaDES")
Require("PredictiveEcology/pemisc")
Require("googledrive")
Require("tati-micheletti/usefulFuns")
...
urlSA <- "https://drive.google.com/file/d/1LxacDOobTrRUppamkGgVAUFIxNT4iiHU/view?usp=sharing"

studyArea <- prepInputs(url = urlSA,
                       destinationPath = Paths$inputPath)

templateRaster <- prepInputs(url = paste0("http://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/",
